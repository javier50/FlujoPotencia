function newthonRhapson(Nodos, Lineas)
%NEWTHON_RHAPSON
%	Funcion que newthon rhapson

%% PARÁMETROS 
nombre_de_la_red ='IEEE 39 NODOS'; % Nombre de la red con la cual se está trabajando para nombre en pantalla
tol=0.01; % Tolerancia en pu
itmax=200; % Número máximo de iteraciones permitido
baseMVA=100;
graus_to_rad=pi/180;
rad_to_graus=180/pi;
[nb,nCol]=size(Nodos); % Número total de nodos
[nr,nCol]=size(Lineas); % Número total de líneas
